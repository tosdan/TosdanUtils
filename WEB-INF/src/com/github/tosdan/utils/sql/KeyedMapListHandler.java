 ...
 * @since DbUtils 1.1
 */
public class KeyedMapListHandler<K> extends AbstractKeyedListHandler<K, Map<String, Object>> {
     ...
     */
    public KeyedMapListHandler(RowProcessor convert) {
        this(convert, 1, null);
    }
     ...
     * retrieved from the column with this name.
     */
    private KeyedMapListHandler(RowProcessor convert, int columnIndex, String columnName) {
        super();
