 ...
 * @author tosdan
 */
public class MyKeyedHandler<K> extends MyAbstractKeyedHandler<K, Map<String, Object>> {
     ...
     */
    public MyKeyedHandler(RowProcessor convert) {
        this(convert, 1, null);
    }
     ...
     */
    public MyKeyedHandler(int columnIndex) {
     ...
     */
    public MyKeyedHandler(String columnName) {
     ...
     * retrieved from the column with this name.
     */
    private MyKeyedHandler(RowProcessor convert, int columnIndex,
            String columnName) {
        super();
