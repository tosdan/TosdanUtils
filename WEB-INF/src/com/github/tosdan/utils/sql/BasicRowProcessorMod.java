 ...
 * @see RowProcessor
 */
public class BasicRowProcessorMod implements RowProcessor {
     ...
     */
    private static final BasicRowProcessorMod instance = new BasicRowProcessorMod();
     ...
     */
    @Deprecated
    public static BasicRowProcessorMod instance() {
        return instance;
    }
